...
@section('title') Supplier - PHP @endsection
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="bootstrap-table">
                            ...
                            <a href="{{ url('admin/supplier/create') }}" class="btn">Create New</a>
                            {{ Form::open(['method' => 'GET' , 'url' => 'admin/supplier']) }}
                                    ...
                                    <table data-toggle="table" data-url="tables/data1.json" data-show-refresh="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="">
                                                    <div class="th-inner sortable">CompanyName<span class="order"><span
                                                ...
                                                <th style="">
                                                    <div class="th-inner sortable">Phone<span class="order"><span
                                                                    class="caret" style="margin: 10px 5px;"></span></span></div>
                                                    <div class="fht-cell"></div>
                                                </th>
                                                <th style="">
                                                    <div class="th-inner sortable">Fax<span class="order"><span
                                                                    class="caret" style="margin: 10px 5px;"></span></span></div>
                                                    <div class="fht-cell"></div>
                                                </th>
                                                <th style="">
                                                    <div class="th-inner sortable">HomePage<span class="order"><span
                                                                    class="caret" style="margin: 10px 5px;"></span></span></div>
                                                    <div class="fht-cell"></div>
                                                </th>
                                            ...
                                            @if($sup)
                                                @foreach($sup as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->homepage }}</td>
                                                        <td>
                                                            {!! Form::open(['method' => 'DELETE', 'url' => 'admin/supplier/' . $item->id]) !!}
